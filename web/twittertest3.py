    ...
    try:
        ...
        for item in iterator:
            if 'text' in item and 'user'  in item:
                ...
                print alchemy_language.sentiment(text=item['text'])["docSentiment"]["type"],': ',furious.objects.filter(result=alchemy_language.sentiment(text=item['text'])["docSentiment"]["type"]).aggregate(Count('id'))['id__count']
